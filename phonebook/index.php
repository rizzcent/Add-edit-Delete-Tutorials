<?php
  echo "<div style='border:1px solid #0000ff; position: relative; left:35%; width: 285px;'>
        <Table border='0' cellpadding='0' >
         <tr><td colspan='2' height='30px' bgcolor='#00FFFF'> <b>&nbsp;&nbsp;Phone Book</b> <td></tr>
        ...
        <tr>
		 ...
		 <tr>
		   <td> Address: </td>  
		   <td> <input type='text' name='address' id='address' size='25'>
		</tr>
		 <tr>
		   <td> Home: </td>  
		   <td> <input type='text' name='home' id='home' size='25'>
		</tr>
 ...
 <script language='javascript' type='text/javascript'>
  function Save_Record()
   {  MobileNo=document.getElementById('mobileNo').value;
	  ...
	  Add_Record(mobileNo,Owner,address,home);
    }
